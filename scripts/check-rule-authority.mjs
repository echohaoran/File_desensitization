...
import { DEFAULT_RULES, detectWithRules, loadSensitiveRules, deleteSensitiveRules, saveSensitiveRules } from '../src/utils/sensitiveRules.js'
const store = new Map()
...
assert.equal(loadSensitiveRules().length, 0)
