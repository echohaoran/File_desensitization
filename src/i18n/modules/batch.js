const rows = [
  ['fixed', '固定字段', 'Fixed field', 'Champ fixe', '固定項目', 'Festes Feld', '고정 필드'],
  ['fixedHint', '手机号、身份证、银行卡号为固定字段，不可删除；可启用或停用。批量删除会跳过固定字段。', 'Mobile phone, ID and bank card fields cannot be deleted. They can be enabled or disabled. Bulk deletion skips them.', 'Les champs téléphone mobile, identité et carte bancaire ne peuvent pas être supprimés. Ils peuvent être activés ou désactivés et sont exclus de la suppression en lot.', '携帯電話、身分証、銀行カード番号は削除できません。有効・無効を切り替えられます。一括削除の対象外です。', 'Mobiltelefon, Ausweis und Bankkartennummer können nicht gelöscht werden. Sie können aktiviert oder deaktiviert werden. Sammellöschen überspringt sie.', '휴대전화, 신분증, 은행카드 번호는 삭제할 수 없습니다. 활성화 또는 비활성화할 수 있으며 일괄 삭제에서 제외됩니다.'],
