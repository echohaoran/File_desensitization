...
- [ ] 在本地应用和安装包中确认新盾牌锁图标显示正确。

- [ ] 在本地 Tauri 包中确认长文本、DOCX 段落及表格的对应检测片段均显示红色双波浪线。

- [x] 2026-08-31 固定视口弹性布局与卡片溢出约束
- [x] 2026-08-31 还原/敏感字段左右布局与设置紧凑卡片布局
- [x] 2026-08-31 五页面卡片尺寸与全局溢出烟测
- [x] 2026-08-31 AI 全文检测增加模拟进度和成功/失败结果弹窗
- [x] 修复 GGUF 下载后缺少 tokenizer 导致本地 AI 推理失败的问题（2026-08-31）
